...
NumberNode.prototype.validate = function validate(value, path) {
    if (null !== this.options.greaterThan && false === (value > this.options.greaterThan)) {
    ...
    if (null !== this.options.greaterOrEqualThan && false === (value >= this.options.greaterOrEqualThan)) {
        throw new ConfigError(
    ...
    if (null !== this.options.lowerThan && false === (value < this.options.lowerThan)) {
        throw new ConfigError(
    ...
    if (null !== this.options.lowerOrEqualThan && false === (value <= this.options.lowerOrEqualThan)) {
        throw new ConfigError(
    ...
    if (null !== this.options.equalTo && value !== this.options.equalTo) {
        throw new ConfigError(
