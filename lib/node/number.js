...
NumberNode.prototype.validate = function validate(value, path) {
    if (null !== this.options.greaterThan && !(value > this.options.greaterThan)) {
    ...
    if (null !== this.options.greaterOrEqualThan && !(value >= this.options.greaterOrEqualThan)) {
        throw new ConfigError(
    ...
    if (null !== this.options.lowerThan && !(value < this.options.lowerThan)) {
        throw new ConfigError(
    ...
    if (null !== this.options.lowerOrEqualThan && !(value <= this.options.lowerOrEqualThan)) {
        throw new ConfigError(
